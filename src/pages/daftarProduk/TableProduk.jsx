              ...
              <tbody className="border-b-[1px] border-gray-300">
                {searchResults.length === 0 ? (
                  ...
                  searchResults.map((item, index) => (
                    <tr
                      className={`text-center text-gray-900 dark:text-colorTwo transition-all ease-in ${index % 2
                        ? "  "
              ...
              <tbody className="border-b-[1px] border-gray-300">
                {currentItems.length === 0 ? (
                  ...
                  currentItems.map((item, index) => (
                    <tr
                      className={`text-center dark:text-colorTwo  transition-all ease-in ${index % 2
                        ? "  "
                        : `bg-gray-100 dark:bg-colorDarkOne/50 transition-all ease-in`
