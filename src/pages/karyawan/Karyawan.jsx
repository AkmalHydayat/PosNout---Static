...
import DataKaryawan from "../../databases/DataKaryawan";

const Karyawan = () => {
  const [grid, setGrid] = useState(true);
  const [table, setTable] = useState(false);
  const { listKaryawan } = DataKaryawan()
          ...
          <div className="px-6 py-[15px] border-b-[1px] space-x-5  transition-all ease-in  border-gray-300  dark:border-colorDarkOne text-colorDarkOne dark:text-colorTwo flex justify-between">
            ...
            <div className="space-x-5 transition-all ease-in">
              <FontAwesomeIcon
                ...
                icon={faGrip}
                className={`h-6 cursor-pointer hover:text-purple-600  transition-all ease-in duration-150 ${grid
                  ? "text-purple-600"
              ...
              <FontAwesomeIcon
                ...
                icon={faGripLines}
                className={`h-6 cursor-pointer hover:text-purple-600  transition-all ease-in duration-150 ${table
                  ? "text-purple-600"
                  : "text-colorDarkOne dark:text-colorTwo"
                  } dark:hover:text-purple-600`}
              />
