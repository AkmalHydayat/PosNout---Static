...
const Transaksi = () => {
  ...
  const [totalKeuntunganPerTransaksi, setTotalKeuntunganPerTransaksi] =
    useState(0);
  const [invoiceNumberCounter, setInvoiceNumberCounter] = useState(1);
  ...
  const generateInvoiceNumber = () => {
    ...
    // Perbarui counter untuk invoice number selanjutnya
    setInvoiceNumberCounter(prevCounter => prevCounter + 1);
